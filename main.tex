...
% título provisório
\title{Privacidade Diferencial aplicada ao problema \\ da escalabilidade na Blockchain}
...
\pchave{Blockchain, Privacidade Diferencial, Escalabilidade}

\keyword{Blockchain. Diferential Privacy. Scalability.}

% autoria
\author{Marc Antonio Vieira de Queiroz}
\advisor{Luis Carlos Erpen de Bona}
\coadvisor{Jacques Duílio Brancher}
\coadvisorsec{André Ricardo Abed Grégio}
